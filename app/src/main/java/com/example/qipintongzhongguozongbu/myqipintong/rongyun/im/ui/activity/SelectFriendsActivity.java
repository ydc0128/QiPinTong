 ...
 * Company RongCloud
 */
public class SelectFriendsActivity extends BaseAActivity implements View.OnClickListener {
    ...
    class StartDiscussionAdapter extends BaseAdapter implements SectionIndexer {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            ImageLoader.getInstance().displayImage(portraitUri, viewHolder.mImageView, AppApplication.getOptions());
            return convertView;
        }
