...
/**
 * Description: 朋友圈图片的处理类
 * Copyright  : Copyright (c) 2016
 * Author     : 感觉自己懵懵哒
 * E-mail     :anber1229423614@163.com
 * Date       : 2017/4/23 下午4:45
 */
public class FriendNineLayout extends NineGridLayout {

    protected static final int MAX_W_H_RATIO = 3;

    public FriendNineLayout(Context context) {
        super(context);
    }

    public FriendNineLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
