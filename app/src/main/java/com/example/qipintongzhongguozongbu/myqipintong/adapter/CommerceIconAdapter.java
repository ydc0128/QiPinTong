 ...
 * Date       : 2017/5/17 ??2:23
 */
public class CommerceIconAdapter extends BaseQuickAdapter<HomeIconBean,BaseViewHolder> {


    public CommerceIconAdapter(int layoutResId, List<HomeIconBean> data) {
