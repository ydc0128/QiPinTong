...
//        insertData("Leo" + time);
        ...
        //点击搜索按钮后的事件
        tv_srarch.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                boolean hasData = hasData(et_search.getText().toString().trim());
                if (!hasData) {
    ...
    private void initView() {
        ...
        tv_srarch = (TextView) findViewById(R.id.tv_search);
        mIvSearch = (ImageView) findViewById(R.id.iv_search);
        ImageView mIvBack = (ImageView) findViewById(R.id.iv_search_back);
        TextView mTvCompany = (TextView) findViewById(R.id.tv_search_company);
        TextView mTvWork = (TextView) findViewById(R.id.tv_search_work);
        TextView mTvProject = (TextView) findViewById(R.id.tv_search_project);
        TextView mTvRecruit = (TextView) findViewById(R.id.tv_search_together);
        TextView mTvTalents = (TextView) findViewById(R.id.tv_search_talents);

        mTvCompany.setOnClickListener(this);
        mTvWork.setOnClickListener(this);
        mTvProject.setOnClickListener(this);
        mTvRecruit.setOnClickListener(this);
        mTvTalents.setOnClickListener(this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.tv_search_work://工作
                et_search.setText("工作");
                break;
            case R.id.tv_search_talents://人才
                et_search.setText("人才");
                break;
            case R.id.tv_search_project://项目
                et_search.setText("项目");
                break;
            case R.id.tv_search_company://企业
                et_search.setText("企业");
                break;
            case R.id.tv_search_together://合伙人
                et_search.setText("合伙人");
                break;
