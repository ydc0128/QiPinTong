 ...
 * Company RongCloud
 */
public class PrivateChatDetailActivity extends BaseAActivity implements View.OnClickListener, CompoundButton.OnCheckedChangeListener {
    ...
    private void initData() {
        if (mUserInfo != null) {
            ...
            ImageLoader.getInstance().displayImage(portraitUri, mImageView, AppApplication.getOptions());
