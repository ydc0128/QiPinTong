...
import com.example.qipintongzhongguozongbu.myqipintong.adapter.PositionListAdapter;
 ...
 * Date       : 2017/5/17 下午3:45
 */
public class PositionList extends BaseFragment {
    ...
    private void setRvAdapter() {
        ...
        idStickynavlayoutInnerscrollview.setAdapter(new PositionListAdapter(R.layout.item_full_time_job, ImageList.getImageList()));
