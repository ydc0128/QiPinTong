...
public class QiPinTongWebActivity extends BaseAActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mMyWebViewClient.onPageFinished(mWebView, "http://www.qipintong.com/");
        mMyWebViewClient.shouldOverrideUrlLoading(mWebView, "http://www.qipintong.com/");
        mMyWebViewClient.onPageFinished(mWebView, "http://www.qipintong.com/");
    ...
    class MyWebViewClient extends WebViewClient {
        ...
        public void onPageStarted(WebView view, String url, Bitmap favicon) {//网页页面开始加载的时候
            if (progressDialog == null) {
                progressDialog = new ProgressDialog(QiPinTongWebActivity.this);
