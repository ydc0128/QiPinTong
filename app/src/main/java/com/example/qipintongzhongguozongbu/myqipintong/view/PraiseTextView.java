...
/**
 * Description: 朋友圈点赞的人名布局
 * Copyright  : Copyright (c) 2016
 * Author     : 感觉自己懵懵哒
 * E-mail     :anber1229423614@163.com
 * Date       : 2017/5/10 上午9:23
 */
public class PraiseTextView extends TextView {
     ...
     * 第一个显示的图标
     */
    private int mIcon = R.mipmap.praise_blue;
    /**
     * 名字文字颜色，分割文本用textview默认的，自行设置即可
     */
    private int mNameTextColor = getResources().getColor(R.color.colorbluebg);
    /**
     * 不设置默认与文字大小匹配
     */
    private Rect mIconSize = new Rect(0,0,55,55);
    /**
     * 中间分割的文本
     */
