...
import com.example.qipintongzhongguozongbu.myqipintong.adapter.RvGoodFaceAdapter;
 ...
 * Date       : 2017/5/17 下午4:26
 */
public class FaceList extends BaseFragment {
    ...
    private void setRvAdapter() {
        ...
        idStickynavlayoutInnerscrollview.setAdapter(new RvGoodFaceAdapter(R.layout.item_good_face, ImageList.getImageList()));
