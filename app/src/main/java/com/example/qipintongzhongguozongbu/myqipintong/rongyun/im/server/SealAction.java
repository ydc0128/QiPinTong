package com.example.qipintongzhongguozongbu.myqipintong.rongyun.im.server;
...
import com.example.qipintongzhongguozongbu.myqipintong.rongyun.im.server.request.AddGroupMemberRequest;
import com.example.qipintongzhongguozongbu.myqipintong.rongyun.im.server.request.AddToBlackListRequest;
import com.example.qipintongzhongguozongbu.myqipintong.rongyun.im.server.request.AgreeFriendsRequest;
import com.example.qipintongzhongguozongbu.myqipintong.rongyun.im.server.request.ChangePasswordRequest;
import com.example.qipintongzhongguozongbu.myqipintong.rongyun.im.server.request.CheckPhoneRequest;
import com.example.qipintongzhongguozongbu.myqipintong.rongyun.im.server.request.CreateGroupRequest;
import com.example.qipintongzhongguozongbu.myqipintong.rongyun.im.server.request.DeleteFriendRequest;
import com.example.qipintongzhongguozongbu.myqipintong.rongyun.im.server.request.DeleteGroupMemberRequest;
import com.example.qipintongzhongguozongbu.myqipintong.rongyun.im.server.request.DismissGroupRequest;
import com.example.qipintongzhongguozongbu.myqipintong.rongyun.im.server.request.FriendInvitationRequest;
import com.example.qipintongzhongguozongbu.myqipintong.rongyun.im.server.request.JoinGroupRequest;
import com.example.qipintongzhongguozongbu.myqipintong.rongyun.im.server.request.LoginRequest;
import com.example.qipintongzhongguozongbu.myqipintong.rongyun.im.server.request.QuitGroupRequest;
import com.example.qipintongzhongguozongbu.myqipintong.rongyun.im.server.request.RegisterRequest;
import com.example.qipintongzhongguozongbu.myqipintong.rongyun.im.server.request.RemoveFromBlacklistRequest;
import com.example.qipintongzhongguozongbu.myqipintong.rongyun.im.server.request.RestPasswordRequest;
import com.example.qipintongzhongguozongbu.myqipintong.rongyun.im.server.request.SendCodeRequest;
import com.example.qipintongzhongguozongbu.myqipintong.rongyun.im.server.request.SetFriendDisplayNameRequest;
import com.example.qipintongzhongguozongbu.myqipintong.rongyun.im.server.request.SetGroupDisplayNameRequest;
import com.example.qipintongzhongguozongbu.myqipintong.rongyun.im.server.request.SetGroupNameRequest;
import com.example.qipintongzhongguozongbu.myqipintong.rongyun.im.server.request.SetGroupPortraitRequest;
import com.example.qipintongzhongguozongbu.myqipintong.rongyun.im.server.request.SetNameRequest;
import com.example.qipintongzhongguozongbu.myqipintong.rongyun.im.server.request.SetPortraitRequest;
import com.example.qipintongzhongguozongbu.myqipintong.rongyun.im.server.request.VerifyCodeRequest;
import com.example.qipintongzhongguozongbu.myqipintong.rongyun.im.server.response.AddGroupMemberResponse;
import com.example.qipintongzhongguozongbu.myqipintong.rongyun.im.server.response.AddToBlackListResponse;
import com.example.qipintongzhongguozongbu.myqipintong.rongyun.im.server.response.AgreeFriendsResponse;
import com.example.qipintongzhongguozongbu.myqipintong.rongyun.im.server.response.ChangePasswordResponse;
import com.example.qipintongzhongguozongbu.myqipintong.rongyun.im.server.response.CheckPhoneResponse;
import com.example.qipintongzhongguozongbu.myqipintong.rongyun.im.server.response.CreateGroupResponse;
import com.example.qipintongzhongguozongbu.myqipintong.rongyun.im.server.response.DefaultConversationResponse;
import com.example.qipintongzhongguozongbu.myqipintong.rongyun.im.server.response.DeleteFriendResponse;
import com.example.qipintongzhongguozongbu.myqipintong.rongyun.im.server.response.DeleteGroupMemberResponse;
import com.example.qipintongzhongguozongbu.myqipintong.rongyun.im.server.response.DismissGroupResponse;
import com.example.qipintongzhongguozongbu.myqipintong.rongyun.im.server.response.FriendInvitationResponse;
import com.example.qipintongzhongguozongbu.myqipintong.rongyun.im.server.response.GetBlackListResponse;
import com.example.qipintongzhongguozongbu.myqipintong.rongyun.im.server.response.GetFriendInfoByIDResponse;
import com.example.qipintongzhongguozongbu.myqipintong.rongyun.im.server.response.GetGroupInfoResponse;
import com.example.qipintongzhongguozongbu.myqipintong.rongyun.im.server.response.GetGroupMemberResponse;
import com.example.qipintongzhongguozongbu.myqipintong.rongyun.im.server.response.GetGroupResponse;
...
import com.example.qipintongzhongguozongbu.myqipintong.rongyun.im.server.response.GetUserInfosResponse;
import com.example.qipintongzhongguozongbu.myqipintong.rongyun.im.server.response.JoinGroupResponse;
import com.example.qipintongzhongguozongbu.myqipintong.rongyun.im.server.response.LoginResponse;
import com.example.qipintongzhongguozongbu.myqipintong.rongyun.im.server.response.QiNiuTokenResponse;
import com.example.qipintongzhongguozongbu.myqipintong.rongyun.im.server.response.QuitGroupResponse;
import com.example.qipintongzhongguozongbu.myqipintong.rongyun.im.server.response.RegisterResponse;
import com.example.qipintongzhongguozongbu.myqipintong.rongyun.im.server.response.RemoveFromBlackListResponse;
import com.example.qipintongzhongguozongbu.myqipintong.rongyun.im.server.response.RestPasswordResponse;
import com.example.qipintongzhongguozongbu.myqipintong.rongyun.im.server.response.SendCodeResponse;
import com.example.qipintongzhongguozongbu.myqipintong.rongyun.im.server.response.SetFriendDisplayNameResponse;
import com.example.qipintongzhongguozongbu.myqipintong.rongyun.im.server.response.SetGroupDisplayNameResponse;
import com.example.qipintongzhongguozongbu.myqipintong.rongyun.im.server.response.SetGroupNameResponse;
import com.example.qipintongzhongguozongbu.myqipintong.rongyun.im.server.response.SetGroupPortraitResponse;
import com.example.qipintongzhongguozongbu.myqipintong.rongyun.im.server.response.SetNameResponse;
import com.example.qipintongzhongguozongbu.myqipintong.rongyun.im.server.response.SetPortraitResponse;
import com.example.qipintongzhongguozongbu.myqipintong.rongyun.im.server.response.SyncTotalDataResponse;
import com.example.qipintongzhongguozongbu.myqipintong.rongyun.im.server.response.UserRelationshipResponse;
import com.example.qipintongzhongguozongbu.myqipintong.rongyun.im.server.response.VerifyCodeResponse;
...
import com.example.qipintongzhongguozongbu.myqipintong.rongyun.im.server.utils.json.JsonMananger;
