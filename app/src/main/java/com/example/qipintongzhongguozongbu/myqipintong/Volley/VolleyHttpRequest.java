package com.example.qipintongzhongguozongbu.myqipintong.Volley;
...
public class VolleyHttpRequest{
	 ...
	 */
	public static void String_request(int i, String url, Map<String, String> map, VolleyHandler<String> volleyRequest){
	 ...
	 */
	public static void Volley_StringRequest(int method,String url,final Map<String,String> params,VolleyHandler<String> volleyRequest){
		...
		AppApplication.getQueue().add(stringrequest);
	}
	 ...
	 * @param volleyRequest  回调函数对象
	 */
	public static void Volley_JsonObjectRequest(int method,String url,JSONObject jsonObject,VolleyHandler<JSONObject> volleyRequest){
		...
		AppApplication.getQueue().add(jsonObjectRequest);
	}
	...
	private static void Volley_ImageRequest(String url,int maxWidth,int maxHeight,VolleyHandler<Bitmap> volleyRequest){
		...
		AppApplication.getQueue().add(imageRequest);
	}
	...
	private static void Volley_ImageLoader(String url,ImageListener imageListener,int maxWidth,int maxHidth){
		...
		// 实例化对象
		ImageLoader imageLoader = new ImageLoader(AppApplication.getQueue(),
