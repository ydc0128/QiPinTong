...
import com.example.qipintongzhongguozongbu.myqipintong.rongyun.im.db.DBManager;
import com.example.qipintongzhongguozongbu.myqipintong.rongyun.im.db.Friend;
import com.example.qipintongzhongguozongbu.myqipintong.rongyun.im.db.GroupMember;
import com.example.qipintongzhongguozongbu.myqipintong.rongyun.im.db.Groups;
import com.example.qipintongzhongguozongbu.myqipintong.rongyun.im.db.GroupsDao;
import com.example.qipintongzhongguozongbu.myqipintong.rongyun.im.model.SealSearchConversationResult;
...
import com.example.qipintongzhongguozongbu.myqipintong.rongyun.im.server.utils.OperationRong;
...
import com.example.qipintongzhongguozongbu.myqipintong.rongyun.im.server.utils.photo.PhotoUtils;
import com.example.qipintongzhongguozongbu.myqipintong.rongyun.im.server.widget.BottomMenuDialog;
...
import com.example.qipintongzhongguozongbu.myqipintong.rongyun.im.ui.widget.DemoGridView;
import com.example.qipintongzhongguozongbu.myqipintong.rongyun.im.ui.widget.switchbutton.SwitchButton;
 ...
 * Company RongCloud
 */
public class GroupDetailActivity extends BaseAActivity implements View.OnClickListener, CompoundButton.OnCheckedChangeListener {
    ...
    private void initGroupData() {
        ...
        ImageLoader.getInstance().displayImage(portraitUri, mGroupHeader, AppApplication.getOptions());
            ...
            switch (requestCode) {
                ...
                case UPDATE_GROUP_HEADER:
                    ...
                    if (response5.getCode() == 200) {
                        ImageLoader.getInstance().displayImage(imageUrl, mGroupHeader, AppApplication.getOptions());
    ...
    private class GridAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (position == getCount() - 1 && isCreated) {
                ...
                ImageLoader.getInstance().displayImage(portraitUri, iv_avatar, AppApplication.getOptions());
                iv_avatar.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
