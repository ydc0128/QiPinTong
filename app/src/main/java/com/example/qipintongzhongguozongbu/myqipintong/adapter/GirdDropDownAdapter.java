...
public class GirdDropDownAdapter extends BaseAdapter {
    ...
    private void fillValue(int position, ViewHolder viewHolder) {
        ...
        if (checkItemPosition != -1) {
            if (checkItemPosition == position) {
                ...
                viewHolder.mText.setCompoundDrawablesWithIntrinsicBounds(null, null, context.getResources().getDrawable(R.mipmap.arrows), null);
            } else {
    ...
    static class ViewHolder {
        ...
        ViewHolder(View view) {
            mText = (TextView) view.findViewById(R.id.tv_item_text);
        }
    }
}
