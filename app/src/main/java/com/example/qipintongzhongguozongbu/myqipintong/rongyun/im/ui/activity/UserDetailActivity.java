...
import com.example.qipintongzhongguozongbu.myqipintong.rongyun.im.ui.widget.SinglePopWindow;
...
public class UserDetailActivity extends BaseAActivity implements View.OnClickListener {

    private static final int SYNC_FRIEND_INFO = 129;

    private ImageView mUserPortrait,mUserGender;
    private TextView mUserNickName,mUserRemarkName,mUserAccountNumber,mUserCity;
...
//    private TextView mUserLineStatus;
    ...
    private RecyclerView mUserPhoto;
    ...
    private void initView() {
        ...
        mUserPhone=(LinearLayout)findViewById(R.id.group_info);
        mUserRemarkName = (TextView) findViewById(R.id.tv_aud_remark_name);
        mUserGender=(ImageView)findViewById(R.id.iv_aud_gender);
        mUserAccountNumber=(TextView)findViewById(R.id.tv_aud_AccountNumber);
        mUserPhoto=(RecyclerView)findViewById(R.id.rv_aud_photo);
        mUserNickName = (TextView) findViewById(R.id.tv_aud_nick_name);
        mUserCity=(TextView)findViewById(R.id.tv_aud_city);
    ...
    private void initData() {
        ...
        if (mFriend != null) {
            if (mFriend.isExitsDisplayName()) {
                ...
                mUserRemarkName.setText(mFriend.getDisplayName());
            } else {
                mUserRemarkName.setText(mFriend.getName());
            }
            String portraitUri = SealUserInfoManager.getInstance().getPortraitUri(mFriend);
            ImageLoader.getInstance().displayImage(portraitUri, mUserPortrait, AppApplication.getOptions());
        }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (resultCode == 155 && data != null) {
            ...
            if (!TextUtils.isEmpty(displayName)) {
                mUserNickName.setVisibility(View.VISIBLE);
                mUserNickName.setText(getString(R.string.ac_contact_nick_name) + " " + mFriend.getName());
                mUserRemarkName.setText(displayName);
