package com.example.qipintongzhongguozongbu.myqipintong.rongyun.im.ui.widget;
...
import com.example.qipintongzhongguozongbu.myqipintong.rongyun.im.ui.activity.ContactsActivity;
import com.example.qipintongzhongguozongbu.myqipintong.rongyun.im.ui.activity.SearchFriendActivity;
import com.example.qipintongzhongguozongbu.myqipintong.rongyun.im.ui.activity.SelectFriendsActivity;
...
public class MorePopWindow extends PopupWindow {
    ...
    public MorePopWindow(final Activity context) {
        ...
        RelativeLayout re_friend= (RelativeLayout) content.findViewById(R.id.re_friend);
        RelativeLayout re_gongxiang=(RelativeLayout)content.findViewById(R.id.re_gongxiang);
        ...
        re_friend.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        re_gongxiang.setOnClickListener(new OnClickListener(){
            @Override
            public void onClick(View v) {
                //共享圈
            }
