...
public class MyAccountActivity extends BaseAActivity implements View.OnClickListener {
            ...
            switch (requestCode) {
                case UP_LOAD_PORTRAIT:
                    ...
                    if (spRes.getCode() == 200) {
                        ...
                        editor.commit();
                        ImageLoader.getInstance().displayImage(imageUrl, mImageView, AppApplication.getOptions());
